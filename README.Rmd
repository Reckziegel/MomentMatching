...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/Reckziegel/MomentMatching.svg?branch=master)](https://travis-ci.com/Reckziegel/MomentMatching)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/Reckziegel/MomentMatching?branch=master&svg=true)](https://ci.appveyor.com/project/Reckziegel/MomentMatching)
...
Now, if we impose the additional assumption that the data generating process (DGP) is normally distributed and we try to get some data from the parameters at hand, 
we are left with: 
